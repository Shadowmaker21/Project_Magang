...
*/
	...
	*/ 
	...
	$config['database']['user_acc']['columns']['bidang_id'] = 'uacc_bidang';
	...
	*/
	...
	$config['email']['site_title'] = "Activation Accounts";
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = "no_reply@jatengprov.go.id";
	...
	*/
	...
	$config['email']['smtp_user'] = "yanmasbarpusjateng@gmail.com";
	 
	/**
	* SMTP Password.
	*/
	 
	$config['email']['smtp_pass'] = "kabidsingyanmas";
	 
	/**
	* SMTP Port . For Gmail is 587. Default is 25
	*/
	...
	*/
	...
	$config['messages']['target_user']['not_loggin'] = 'public';

	// Account Changes
	$config['messages']['target_user']['save_successful'] = 'public';
	$config['messages']['target_user']['save_unsuccessful'] = 'public';
