...
<div class="wrapper">
                    ...
                    <div id="settings_kap">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title">Periode Lists</h3>
    ...
    <script type="text/javascript">
        function refresh(){
            show_ajax('POST','<?php echo base_url('admin/periode_view')?>',null,'html','#boks');
        }
        refresh();
        function add(){
            $("#tombol").html(' ');
            data={judul:'Tambah Periode Baru',name:' '};
            modal_ajax(data,'POST','<?php echo base_url('admin/new_periode')?>','html','#preview',0);
        }
