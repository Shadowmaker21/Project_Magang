...
<head>
  ...
  <link href="<?php echo base_url('includes/backend-material/font-awesome/css/font-awesome.css')?>" rel="stylesheet">
  ...
  <script src="<?php echo base_url('includes/backend-lte/js/jquery.js')?>"></script>
  ...
  <body class="hold-transition content-background">
    <div class="login-box">
      <div class="login-logo cover" style="padding-left:90px;">
        <a href="../../index2.html" class="oxygen600"><b>E-</b>VISITOR</a>
      ...
      <div class="login-box-body">
        ...
        <?php echo form_open(base_url('authenticate'),array('class'=>'form-signin'));?>    
          ...
          <div class="form-group has-feedback">
            <input type="text" name="login_identity" id="identity" class="form-control input-lg opensans16" placeholder="Username">
            <span class="fa fa-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="password" id="password" name="login_password" class="opensans16 form-control input-lg" placeholder="Password">
