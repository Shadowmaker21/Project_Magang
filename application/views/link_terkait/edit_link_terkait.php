                    ...
                    <div class="col-xs-6">
                      <?php echo form_open_multipart('link_terkait/link_terkait_upload');?>
                        ...
                        <div class="form-group">
                          <label>Link</label>
                          <input type="text" class="form-control" name="link" value="<?php echo $d->link ?>" required id="link" placeholder="Tautkan Link">
                        </div>
                        <div class="form-group">
                          <label>Deskripsi</label>
                          <input type="text" class="form-control" name="deskripsi" value="<?php echo $d->deskripsi ?>" required id="deskripsi" placeholder="Deskripsi">
                        </div>
                        <div class="form-group">
