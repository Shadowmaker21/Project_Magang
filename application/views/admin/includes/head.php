...
<head>
    ...
    <link href="<?php echo base_url('template/plugins/izitoast/css/iziToast.min.css')?>" rel="stylesheet" />
    ...
    <script src="<?php echo base_url('template/plugins/pace/pace.min.js')?>"></script>
    ...
    <script src="<?php echo base_url('template/plugins/izitoast/js/iziToast.min.js')?>"></script>
    <!-- Custom Js -->
    ...
    function view_dashboard(){
        show_ajax('POST',"<?php echo base_url('admin/view_dashboard')?>",null,'html','#place');
    }
    
    function view_grup(){
        show_ajax('POST',"<?php echo base_url('grup/view_table')?>",null,'html','#place');
    }

    function data_grup(){
        show_ajax('POST',"<?php echo base_url('grup/view_table')?>",null,'html','#data_grup');
    }

    function add_grup(size,color){
        var datas = null;
        show_ajax('POST','<?php echo base_url('grup/new_grup')?>',datas,'html','#place');
    }

    function edit_grup(id){
        var datas = {id:id};
        show_ajax('POST','<?php echo base_url('grup/edit_grup')?>',datas,'html','#place');
    }
    function validate_grup(form){
        $(form).validate({
        ...
        iziToast.question({
            ...
            buttons: [
                ['<button><b>Ya</b></button>', function (instance, toast) {
                    ...
                    data = {id:id};
                    submit_ajax('POST','<?php echo base_url('grup/delete_grup')?>',data,'json',1);
                }, true],
    ...
    function view_user(){
        show_ajax('POST',"<?php echo base_url('user/view_table')?>",null,'html','#place');
    }

    function data_akun(){
        show_ajax('POST',"<?php echo base_url('akun/view_table')?>",null,'html','#data_akun');
    }
    </script>
</head>
...
<body class="theme-red">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" id="block" class="btn btn-link waves-effect">SAVE CHANGES</button>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?php echo base_url('template/images/user.png')?>" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo ucwords(strtolower($user['uacc_username'])) ?></div>
                    <div class="email"><?php echo $user['uacc_email'] ?></div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?php echo base_url('hakases')?>">
