<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        ...
        <div class="body">
            <form class="form-horizontal" id="newgrup" method="POST" action="<?php echo base_url('grup/store_grup')?>">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-6 col-xs-5">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="desc" name="desc" class="form-control" placeholder="Admin : has not full admin access rights" required autofocus>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row clearfix">
                    <div class="col-lg-offset-3 col-md-offset-3 col-sm-offset-4 col-xs-offset-5">
                        <button type="submit" class="btn btn-primary m-t-15 waves-effect" id="simpan">SIMPAN</button>
                    </div>
                </div>
            </form>
        </div>
