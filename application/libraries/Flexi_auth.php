...
class Flexi_auth extends Flexi_auth_lite
{
	 ...
	 * @author Rob Hussey
	 */
	public function insert_user($email, $username = FALSE, $bidang = FALSE, $password, $user_data, $group_id = FALSE, $activate = FALSE) 
	{
		$user_id = $this->CI->flexi_auth_model->insert_user($email, $username, $bidang, $password, $user_data, $group_id);
	...
	/**
	 * insert_user_news
	 * Inserts data into a custom user news table and returns the table name and row id of each record inserted.
	 *
	 * @return array/void
	 * @author Rob Hussey
	 */
	public function insert_user_news_data($user_id = FALSE, $custom_data = FALSE)
	{
		if ($row_data = $this->CI->flexi_auth_model->insert_custom_user_data($user_id, $custom_data))
		{
			$this->CI->flexi_auth_model->set_status_message('update_successful', 'config');
	...
	/**
	 * insert_category_news
	 * Inserts data into a custom category news table and returns the table name and row id of each record inserted.
	 *
	 * @return array/void
	 * @author Rob Hussey
	 */
	public function insert_category_news($name)
	{
		if ($row_data = $this->CI->flexi_auth_model->insert_category_news($name,@$custom_data))
		{
			$this->CI->flexi_auth_model->set_status_message('update_successful', 'config');
			return $row_data;
		}
	...
	/**
	 * insert_news
	 * Inserts a new news user to the database. If the group has admin privileges this can be set using $is_admin = TRUE.
	 *
	 * @return void
	 * @author Rob Hussey
	 */
	public function insert_user_news($user_id, $news_name, $news_desc, $custom_data = array())
	{
		if ($user_id = $this->CI->flexi_auth_model->insert_user_news($user_id, $news_name, $news_desc, $custom_data));
		{
			$this->CI->flexi_auth_model->set_status_message('update_successful', 'config');
			return $user_id;
		}
	...
	// insert berita berkategori
	public function insert_user_news_categorized($user_id, $news_name, $news_desc, $category_id, $custom_data = array())
	{
		if ($user_id = $this->CI->flexi_auth_model->insert_user_news_categorized($user_id, $news_name, $news_desc, $category_id, $custom_data));
		{
			$this->CI->flexi_auth_model->set_status_message('update_successful', 'config');
			return $user_id;
		}
	 ...
	 * Deletes a news category from the news_category table.
	 *
	 * @return bool
	 * @author Rob Hussey
	 */
	public function delete_category($sql_where)
	{
		if ($this->CI->flexi_auth_model->delete_category($sql_where))
		{
			$this->CI->flexi_auth_model->set_status_message('delete_successful', 'config');
			return TRUE;
		}
	...
	// untuk menghapus berita berkategori pada public_example
	public function hapus_berita_kategori($sql_where){
		if ($this->CI->flexi_auth_model->hapus_beritakategori($sql_where))
		{
			$this->CI->flexi_auth_model->set_status_message('delete_successful', 'config');
			return TRUE;
		}
	...
	/**
	 * delete_user_news
	 * Deletes a user news from the news_category table.
	 *
	 * @return bool
	 * @author Rob Hussey
	 */
	public function delete_user_news($sql_where)
	{
		if ($this->CI->flexi_auth_model->delete_user_news($sql_where))
		{
			$this->CI->flexi_auth_model->set_status_message('delete_successful', 'config');
			return TRUE;
		}
	...
	/**
	 * update_news_
	 * Updates a news with any submitted data.
	 *
	 * @return bool
	 * @author Rob Hussey
	 */
	function update_news($news_id,$news_data){
		if ($this->CI->flexi_auth_model->update_news($news_id, $news_data))
		{
			$this->CI->flexi_auth_model->set_status_message('update_successful', 'config');
			return TRUE;
		}
	 ...
	 * Updates a news category with any submitted data.
	 *
	 * @return bool
	 * @author Rob Hussey
	 */

	//untuk admin manage_news_category
	public function update_news_category($news_category_id, $news_category_data)
	{
		if ($this->CI->flexi_auth_model->update_news_category($news_category_id, $news_category_data))
		{
			$this->CI->flexi_auth_model->set_status_message('update_successful', 'config');
			return TRUE;
		}
	...
	public function perbarui_news_category($news_category_id, $news_category_data)
	{
		if ($this->CI->flexi_auth_model->perbarui_news_category($news_category_id, $news_category_data))
		{
			$this->CI->flexi_auth_model->set_status_message('update_successful', 'config');
			return TRUE;
		}
	 ...
	 * @author Rob Hussey
	 */
	// search berita berkategori
	public function search_news_query($search_query = FALSE, $exact_match = FALSE, $sql_select = FALSE, $sql_where = FALSE, $sql_group_by = TRUE)
	{
		// return $this->CI->flexi_auth_model->search_users($search_query, $exact_match, $sql_select, $sql_where, $sql_group_by);
		return $this->CI->flexi_auth_model->search_news($search_query, $exact_match, $sql_select, $sql_where, $sql_group_by);
	}
	// search berita terbaru
	public function search_news_new_query($search_query = FALSE, $exact_match = FALSE, $sql_select = FALSE, $sql_where = FALSE, $sql_group_by = TRUE)
	{
		// return $this->CI->flexi_auth_model->search_users($search_query, $exact_match, $sql_select, $sql_where, $sql_group_by);
		return $this->CI->flexi_auth_model->search_news_new($search_query, $exact_match, $sql_select, $sql_where, $sql_group_by);
	}
	...
	// BARU NEWS CATEGORY
	public function get_news_category_query($sql_select = FALSE, $sql_where = FALSE)
	{
		return $this->CI->flexi_auth_model->get_news_category($sql_select, $sql_where);
	}

	// BARU USER NEWS
	public function get_user_news_query($sql_select = FALSE, $sql_where = FALSE)
	{
		return $this->CI->flexi_auth_model->get_user_news($sql_select, $sql_where);
	}

	// BARU NEWS
	public function get_news_query($sql_select = FALSE, $sql_where = FALSE)
	{
		return $this->CI->flexi_auth_model->get_news($sql_select, $sql_where);
	}	
	// mendapatkan data kategori berita berkategori
	public function get_kategori_query($sql_select = FALSE, $sql_where = FALSE)
	{
		return $this->CI->flexi_auth_model->get_kategori($sql_select, $sql_where);
	}	
	function get_user_news_category_query($sql_select = FALSE, $sql_where = FALSE){
		return $this->CI->flexi_auth_model->get_user_news_category($sql_select, $sql_where);	
	}
	...
	public function reset_pass($identity,$new_password,$salt){
		if ($this->CI->flexi_auth_model->reset_pass($identity, $new_password, $salt))
		{
			$this->CI->flexi_auth_model->set_status_message('password_change_successful', 'config');
			return TRUE;
		}
